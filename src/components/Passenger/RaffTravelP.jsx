...
export default function TravelP() {
      ...
      <div>
        ...
        >
          ...
          <div className="lg:flex min-[315px]:flex-row gap-8 justify-center">
            ...
            <div
              onClick={() => navigate("DaewooExpress")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
              <p className="text-sm">Daewoo Express</p>
            </div>
            <div
              onClick={() => navigate("RoadMaster")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
              <p className="text-sm">Road Master</p>
            </div>
            <div
              onClick={() => navigate("NiaziExpress")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
              <p className="text-sm">Niazi Express</p>
            </div>
            <div
              onClick={() => navigate("QConnect")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
              <p className="text-sm">Q Connect</p>
            </div>
            <div
              onClick={() => navigate("Skyways")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
              <p className="text-sm">Skyways</p>
            </div>
            <div
              onClick={() => navigate("WaraichExpress")}
              className="text-center p-2 bg-transparent rounded-2xl cursor-pointer shadow-sm shadow-black/50 hover:shadow-black"
            >
